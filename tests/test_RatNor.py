...
class TestSpeciesData(test_species.SpeciesTestBase):
    ...
    @pytest.mark.skip("Ensemble id not done yet")
    def test_ensembl_id(self):
        assert self.species.ensembl_id == -1

    # QC Tests. These tests are performed by another contributor
    # independently referring to the citations provided in the
    # species definition, filling in the appropriate values
    # and deleting the pytest "skip" annotations.
    @pytest.mark.skip("Name not done yet")
    def test_name(self):
        assert self.species.name == -1

    # QC Tests. These tests are performed by another contributor
    # independently referring to the citations provided in the
    # species definition, filling in the appropriate values
    # and deleting the pytest "skip" annotations.
    @pytest.mark.skip("Common name not done yet")
    def test_common_name(self):
        assert self.species.common_name == -1
...
class TestGenomeData(test_species.GenomeTestBase):
    ...
    # species definition, filling in the appropriate values
    # and deleting the pytest "skip" annotations.
    @pytest.mark.skip("Chromosome ploidy QC not done yet")
