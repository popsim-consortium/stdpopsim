...
latex_documents = [
    (master_doc, 'stdpopsim.tex', 'stdpopsim Documentation',
     'PopSim Consortium', 'manual'),
]
...
man_pages = [
    (master_doc, 'stdpopsim', 'stdpopsim Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'stdpopsim', 'stdpopsim Documentation',
     author, 'stdpopsim', 'One line description of project.',
     'Miscellaneous'),
]
